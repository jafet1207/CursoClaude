...
| 4 | [6.1](ESPECIFICACION.md) — Cancelación permitida solo si faltan ≥24h exactas para el bloque | La regla compara únicamente la fecha de la reserva contra la fecha actual, sin la hora: una reserva para mañana se puede cancelar aunque falten menos de 24 horas para el bloque | Comportamiento | `test/reservas.test.js::6.1 — no permite cancelar si faltan menos de 24 horas exactas para el bloque` |
